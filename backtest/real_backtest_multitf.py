"""
بکتست استراتژی Multi-Timeframe Pullback
"""
...
COINS = ['BTC_USDT', 'ETH_USDT', 'SOL_USDT', 'BNB_USDT', 'XRP_USDT',
         'DOGE_USDT', 'ADA_USDT', 'SUI_USDT', 'UNI_USDT', 'LINK_USDT']

def main():
    print("🚀 بکتست استراتژی Multi-Timeframe Pullback")
    print("=" * 60)
    ...
    for symbol in COINS:
        try:
            ...
            df_4h = client.get_candles(symbol, '4h', 200)
            ...
            signals = strategy.generate_signals(df_5m, df_1h, df_4h)
