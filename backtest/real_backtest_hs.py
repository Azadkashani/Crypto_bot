"""
بکتست استراتژی Head and Shoulders
"""
...
def main():
    print("🚀 بکتست استراتژی Head & Shoulders")
    print("=" * 60)
    ...
    for symbol in COINS:
        try:
            ...
            print(f"   الگوی سقف: {signals['bear_signal'].sum()}")
            print(f"   الگوی کف: {signals['bull_signal'].sum()}")
