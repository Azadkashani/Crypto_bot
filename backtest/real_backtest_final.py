...
# حذف HYPE و ZEC
FINAL_COINS = ['BTC_USDT', 'ETH_USDT', 'SOL_USDT', 'BNB_USDT', 'XRP_USDT',
               'DOGE_USDT', 'ADA_USDT', 'SUI_USDT', 'UNI_USDT', 'LINK_USDT']

def main():
    print("🚀 بکتست نهایی - ۱۰ ارز + R:R = 2.0")
    print("=" * 60)
    ...
    # تغییر پارامترها
    strategy.config['atr_mult_sl'] = 2.5
    strategy.config['atr_mult_tp'] = 5.0
    
    all_results = []
    
    for symbol in FINAL_COINS:
        try:
            print(f"\n🔍 {symbol}")
