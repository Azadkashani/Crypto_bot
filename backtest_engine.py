        ...
        for decision_time in decision_times:
            ...
            for best in selected:
                ...
                self.open_positions[best["symbol"]] = {
                    ...
                    "leverage": float(best.get("leverage", 0.0)),
                    "margin_allocation": float(best.get("margin_allocation", 0.0)),
                    "notional_position_value": float(best.get("notional_position_value", 0.0)),
