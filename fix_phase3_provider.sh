...
echo "🔧 اصلاح provider برای مدیریت صحیح error=None..."

cd ~/Crypto_bot

# --------------------------------------------------------------------
# بازنویسی rpc_provider.py با منطق صحیح بررسی خطا
# --------------------------------------------------------------------
...
git add -A
git commit -m "fix: correct RPC error handling in Ethereum provider; complete Phase 3" || echo "No changes to commit"
git push origin main

echo "🎉 Phase 3 با موفقیت انجام شد و به گیت‌هاب Push شد."
